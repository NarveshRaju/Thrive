  ...
  return (
    <div className="bg-[#0B0D10] text-white min-h-screen font-sans antialiased">
      ...
      <div className="pt-16 min-h-screen flex items-center justify-center">
        <main className="pb-10 px-4 md:px-8 flex justify-center w-full">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-2xl bg-[#0E1116] border border-[#1F242D] p-5 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mb-4">
                    Start with a clean document and let AI help you craft every
                    section.
                  </p>
                </div>
              ...
              <div className="rounded-2xl bg-[#0E1116] border border-[#1F242D] p-5 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-400 mb-4">
                    Import your current resume (PDF / DOCX) and let AI optimize
                    it.
                  </p>
                </div>
